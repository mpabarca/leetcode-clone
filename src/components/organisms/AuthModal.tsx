    ...
    return(
        <>
            <div
                ...
                onClick={closeModal}
            ></div>
            <div className='w-full sm:w-[500px] absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] flex justify-center items-center'>
                <div className='relative w-full h-full mx-auto flex items-center justify-center'>
                    <div className='bg-dark-brown rounded-lg shadow relative w-full mx-6 border-4 border-solid border-dark-orange'>
